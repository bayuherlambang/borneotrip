...
class DestinasiKuliner extends Controller
{
    public function index()
    {
        //$this->logActivity("Membuka Halaman Layanan Informasi Berkala");
        $title = 'Destinasi Kuliner';
        return View('admin/page/destinasi_kuliner', compact('title'));
    }

    public function getData()
    {
        $cat = CategoryPosts::where('name', 'Kuliner')->first()->id;
    ...
    public function create(Request $request)
    {
		...
		*/
        ...
        $upload = Articles::create([
            ...
            'category_id' => CategoryPosts::where('name', 'Kuliner')->first()->id
        ]);
        ...
        return redirect()->route('admin_destinasi_kuliner_index')
            ->with([
                'status' => 'success',
                'title' => 'Berhasil Menambah Destinasi Kuliner',
