...
@section('content')
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <button class="btn btn-primary btn-tambah open-modal" data-id="create">Tambah Destinasi</button>
            </div>
            <div class="col-md-12">
                <br>
        ...
        $(document).ready(function(){
            ...
            var Table = $('#data-artikel').DataTable({
                "ajax": {
                    ...
                    "url": "{{ route('admin_destinasi_data') }}",
                    "type": "post"
                },
                "ordering": false,
                "Processing": true,
            ...
            $('#data-artikel tbody').on('click', '.delete-btn', function(){
                ...
                if(confirm("apakah anda yakin akan menghapus destinasi ini ?")){
                    $.ajax({
                        ...
                        type: "POST",
                        url: "{{ route('admin_destinasi_delete') }}",
                        data: "id="+datas["id"]
                    }).done(function(res){
                        if(res.success){
            ...
            $('#data-artikel tbody').on('click', '.active-btn', function(){
                ...
                if(confirm("apakah anda yakin akan mengaktifkan artikel ini ?")){
                    $.ajax({
                        ...
                        type: "POST",
                        url: "{{ route('admin_destinasi_active') }}",
                        data: "id="+datas["id"]
                    }).done(function(res){
                        if(res.success){
                            Table.ajax.reload( null, false );
            ...
            $('#data-artikel tbody').on('click', '.nonactive-btn', function(){
                ...
                if(confirm("apakah anda yakin akan mentidakaktifkan artikel ?")){
                    $.ajax({
                        ...
                        type: "POST",
                        url: "{{ route('admin_destinasi_deactive') }}",
                        data: "id="+datas["id"]
                    }).done(function(res){
                        if(res.success){
                            Table.ajax.reload( null, false );
            ...
            $('#data-artikel tbody').one('click', '.edit-btn', function(){
                ...
                var kategori_id=datas['kategori_id'];
                $('#editkategori').val(kategori_id).change();
            ...
            $('#form-edit').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    'url': "{{ route('admin_destinasi_update') }}",
                    type: "post",
                    data: dataform,
    ...
    <div class="modal modal-new" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" id="form-tambah" action="{{route('admin_destinasi_create')}}" method="POST" enctype="multipart/form-data">
                    {!! csrf_field() !!}
    ...
    <div class="modal modal-edit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="modal-edit">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" id="form-edit" action="{{route('admin_destinasi_update')}}" method="POST" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Kategori</label>
                            <div class="col-sm-9">
                                <select class="form-control" name="kategori_id" id="editkategori">
                                    @foreach($kategori as $k)
                                    <option  value="{{$k['id']}}">{{$k['name']}}</option>
                                    @endforeach
                                </select>
    ...
    <div class="modal modal-gambar" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" id="form-edit-gambar" action="{{route('admin_destinasi_update_gambar')}}" method="POST" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <input type="hidden" value="" name="id" class="editid">
                    <div class="modal-body">
                        <div class="form-group">
