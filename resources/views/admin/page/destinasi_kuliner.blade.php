...
@section('content')
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Destinasi Kuliner</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <button class="btn btn-primary btn-tambah">Tambah Destinsi Kuliner</button>
            </div>
            <div class="col-md-12">
                <br>
        ...
        $(document).ready(function(){
            ...
            var Table = $('#data-artikel').DataTable({
                "ajax": {
                    ...
                    "url": "{{ route('admin_destinasi_kuliner_data') }}",
                    "type": "post"
                },
                "ordering": false,
                "Processing": true,
            ...
            $('#data-artikel tbody').on('click', '.delete-btn', function(){
                ...
                if(confirm("apakah anda yakin akan menghapus destinasi ini ?")){
                    $.ajax({
                        ...
                        type: "POST",
                        url: "{{ route('admin_destinasi_kuliner_delete') }}",
                        data: "id="+datas["id"]
                    }).done(function(res){
                        if(res.success){
            ...
            $('#data-artikel tbody').on('click', '.active-btn', function(){
                ...
                if(confirm("apakah anda yakin akan mengaktifkan artikel ini ?")){
                    $.ajax({
                        ...
                        type: "POST",
                        url: "{{ route('admin_destinasi_kuliner_active') }}",
                        data: "id="+datas["id"]
                    }).done(function(res){
                        if(res.success){
                            Table.ajax.reload( null, false );
            ...
            $('#data-artikel tbody').on('click', '.nonactive-btn', function(){
                ...
                if(confirm("apakah anda yakin akan mentidakaktifkan artikel ?")){
                    $.ajax({
                        ...
                        type: "POST",
                        url: "{{ route('admin_destinasi_kuliner_deactive') }}",
                        data: "id="+datas["id"]
                    }).done(function(res){
                        if(res.success){
                            Table.ajax.reload( null, false );
            ...
            $('#form-edit').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    'url': "{{ route('admin_destinasi_kuliner_update') }}",
                    type: "post",
                    data: dataform,
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Tambah Destinasi Kuliner</h4>
                </div>
                <form class="form-horizontal" id="form-tambah" action="{{route('admin_destinasi_kuliner_create')}}" method="POST" enctype="multipart/form-data">
                    {!! csrf_field() !!}
    ...
    <div class="modal modal-edit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" id="form-edit" action="{{route('admin_destinasi_kuliner_update')}}" method="POST" enctype="multipart/form-data">
                    {!! csrf_field() !!}
    ...
    <div class="modal modal-gambar" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" id="form-edit-gambar" action="{{route('admin_destinasi_kuliner_update_gambar')}}" method="POST" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <input type="hidden" value="" name="id" class="editid">
                    <div class="modal-body">
                        <div class="form-group">
